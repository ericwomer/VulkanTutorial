...
void vkTutorialApp::cleanup_swapchain()
{
...
* @return false
*/
bool vkTutorialApp::is_device_suitable(VkPhysicalDevice dev)
{
  QueueFamilyIndices indicies           = find_queue_families(dev);
  bool               extensionSupported = check_device_extension_support(dev);
  bool               swapChainAdequate  = false;

  if (extensionSupported) {
    SwapChainSupportDetails swapChainSupport = query_swap_chain_support(dev);
 ...
 * @return
 */
VkFormat vkTutorialApp::find_supported_format(const std::vector<VkFormat>& candidates,
 ...
 * @return
 */
VkFormat vkTutorialApp::find_depth_format()
{
 ...
 * @return
 */
bool vkTutorialApp::has_stencil_component(VkFormat format)
{
 ...
 * @brief
 */
void vkTutorialApp::create_depth_resources()
{
...
{
  textureImageView = create_image_view(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_ASPECT_COLOR_BIT);
}
 ...
 * @return
 */
VkImageView vkTutorialApp::create_image_view(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
...
VkCommandBuffer vkTutorialApp::begin_single_time_commands()
{
...
void vkTutorialApp::end_single_time_commands(VkCommandBuffer commandBuffer)
{
 ...
 * @param size
 */
void vkTutorialApp::copy_buffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
 ...
 * @param newLayout
 */
void vkTutorialApp::transition_image_layout(VkImage       image,
                                            VkFormat      format,
 ...
 * @param height
 */
void vkTutorialApp::copy_buffer_to_image(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
  VkCommandBuffer commandBuffer = begin_single_time_commands();
 ...
 * @param bufferMemory
 */
void vkTutorialApp::create_buffer(VkDeviceSize          size,
...
void vkTutorialApp::create_descriptor_set_layout()
{
